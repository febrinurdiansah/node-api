...
async function fetchCategories() {
  ...
  try {
    ...
    // Mengambil daftar kategori dari data JSON
    const categories = data.data['Republika News'].listType;
    return categories;
  } catch (error) {
...
async function fetchData(category) {
  const apiUrl = `https://berita-indo-api-next.vercel.app/api/republika-news/${category}/`;
...
// Endpoint untuk data kategori berita
